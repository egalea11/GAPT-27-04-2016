...
/****** Object:  Database [ToursDbTest]    Script Date: 19/05/2016 14:39:02 ******/
CREATE DATABASE [ToursDbTest]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'ToursDbTest', FILENAME = N'c:\Program Files\Microsoft SQL Server\MSSQL11.SQLEXPRESS\MSSQL\DATA\ToursDbTest.mdf' , SIZE = 5120KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'ToursDbTest_log', FILENAME = N'c:\Program Files\Microsoft SQL Server\MSSQL11.SQLEXPRESS\MSSQL\DATA\ToursDbTest_log.ldf' , SIZE = 2048KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO

ALTER DATABASE [ToursDbTest] SET COMPATIBILITY_LEVEL = 110
GO

IF (1 = FULLTEXTSERVICEPROPERTY('IsFullTextInstalled'))
begin
EXEC [ToursDbTest].[dbo].[sp_fulltext_database] @action = 'enable'
end
GO

ALTER DATABASE [ToursDbTest] SET ANSI_NULL_DEFAULT OFF 
GO

ALTER DATABASE [ToursDbTest] SET ANSI_NULLS OFF 
GO

ALTER DATABASE [ToursDbTest] SET ANSI_PADDING OFF 
GO

ALTER DATABASE [ToursDbTest] SET ANSI_WARNINGS OFF 
GO

ALTER DATABASE [ToursDbTest] SET ARITHABORT OFF 
GO

ALTER DATABASE [ToursDbTest] SET AUTO_CLOSE OFF 
GO

ALTER DATABASE [ToursDbTest] SET AUTO_CREATE_STATISTICS ON 
GO

ALTER DATABASE [ToursDbTest] SET AUTO_SHRINK OFF 
GO

ALTER DATABASE [ToursDbTest] SET AUTO_UPDATE_STATISTICS ON 
GO

ALTER DATABASE [ToursDbTest] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO

ALTER DATABASE [ToursDbTest] SET CURSOR_DEFAULT  GLOBAL 
GO

ALTER DATABASE [ToursDbTest] SET CONCAT_NULL_YIELDS_NULL OFF 
GO

ALTER DATABASE [ToursDbTest] SET NUMERIC_ROUNDABORT OFF 
GO

ALTER DATABASE [ToursDbTest] SET QUOTED_IDENTIFIER OFF 
GO

ALTER DATABASE [ToursDbTest] SET RECURSIVE_TRIGGERS OFF 
GO

ALTER DATABASE [ToursDbTest] SET  DISABLE_BROKER 
GO

ALTER DATABASE [ToursDbTest] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO

ALTER DATABASE [ToursDbTest] SET DATE_CORRELATION_OPTIMIZATION OFF 
GO

ALTER DATABASE [ToursDbTest] SET TRUSTWORTHY OFF 
GO

ALTER DATABASE [ToursDbTest] SET ALLOW_SNAPSHOT_ISOLATION OFF 
GO

ALTER DATABASE [ToursDbTest] SET PARAMETERIZATION SIMPLE 
GO

ALTER DATABASE [ToursDbTest] SET READ_COMMITTED_SNAPSHOT OFF 
GO

ALTER DATABASE [ToursDbTest] SET HONOR_BROKER_PRIORITY OFF 
GO

ALTER DATABASE [ToursDbTest] SET RECOVERY SIMPLE 
GO

ALTER DATABASE [ToursDbTest] SET  MULTI_USER 
GO

ALTER DATABASE [ToursDbTest] SET PAGE_VERIFY CHECKSUM  
GO

ALTER DATABASE [ToursDbTest] SET DB_CHAINING OFF 
GO

ALTER DATABASE [ToursDbTest] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO

ALTER DATABASE [ToursDbTest] SET TARGET_RECOVERY_TIME = 0 SECONDS 
GO

ALTER DATABASE [ToursDbTest] SET  READ_WRITE 
GO
